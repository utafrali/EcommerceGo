...
import (
	...
	"github.com/utafrali/EcommerceGo/services/campaign/migrations"
)
...
func NewApp(cfg *config.Config, logger *slog.Logger) (*App, error) {
	...
	database.RegisterPoolMetrics(pool, "campaign")
	...
	// HTTP router.
	router := handler.NewRouter(campaignService, healthHandler, logger, cfg.PprofAllowedCIDRs)
